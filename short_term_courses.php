	...
	.roow  table { 
       ...
       .roow  th { 
        ...
        (min-device-width: 768px) and (max-device-width: 1024px)  {
           ...
           .roow  table, .roow thead, .roow tbody,.roow th,.roow td,.roow tr { 
                display: block; 
            }
           ...
           .roow  tr { border: 1px solid #ccc; }
            ...
            Label the data
            */
           .roow td:nth-of-type(1):before { content: "Course Name"; }
		   .roow td:nth-of-type(2):before { content: "Duration"; }
		   .roow td:nth-of-type(3):before { content: "No. Of. Participants"; }
		   .roow td:nth-of-type(4):before { content: "Coloboration"; }
		   .roow td:nth-of-type(5):before { content: "Wars of Trek?"; }
		   .roow td:nth-of-type(6):before { content: "Secret Alias"; }
		   .roow td:nth-of-type(7):before { content: "Date of Birth"; }
		   .roow td:nth-of-type(8):before { content: "Dream Vacation City"; }
		   .roow td:nth-of-type(9):before { content: "GPA"; }
		   .roow td:nth-of-type(10):before { content: "Arbitrary Data"; }
        }
